                ...
                <section class="col-l4 col-sm-6">
                    ...
                    <form action="" method="post" name="myform">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control mb-1" placeholder="Day eg(01)" name="Day">
                            <input type="text" class="form-control mb-1" placeholder="Month eg(01)" name="month">
                            <input type="text" class="form-control mb-1" placeholder="year eg(2021)" name="year">
                        </div>
                        <div class="mb-4">
